...
import com.shinian.util.uc.model.IP;
...
public class AccessProxy {
	...
	// sdk server的接口地址
//	private static String serverHost = "http://sdk.test4.g.uc.cn/";
	private static String serverHost = "http://sdk.g.uc.cn/";
	

	private static String accountVerifySession_url="cp/account.verifySession";
	// 分配给游戏合作商的接入密钥,请做好安全保密
	private static String apiKey = "899649e307bb38db44a2a1eb784fb235";
	private static int gameId = 551235;
//	apiKey：899649e307bb38db44a2a1eb784fb235
//	cpId：36656
//	gameId：551235
	public AccessProxy() {
	...
	public String assemblyParameters(String service, Map<String,Object> data) throws Exception {
		...
		String body = JSON.toJSONString(params);// 把参数序列化成一个json字符串
	...
	public String doPost(String service, Map<String,Object> data) {
		...
		try {
			...
			String serviceUrl = accountVerifySession_url;
