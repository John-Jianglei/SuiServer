...
public class Message implements Serializable{
	...
	public final static int accMsgCodeEmialLength = 4023;
	public final static String accMsgEmial = "您输入的账号不是邮箱,请重新输入";
	public final static String accMsgEmialLength = "账号由6-20位数字或字母组成";
	
	public final static int accMsgCodeUcException = 4024;
	public final static String accMsgUcException = "接口返回异常";
	
	public final static int accMsgCodeEmailNull = 4025;
	public final static String accMsgEmailNull = "邮箱已使用，无法继续绑定，请更换邮箱。";
	
	
	public final static int accMsgCodeEmailCode = 4026;
	public final static String accMsgEmailCode = "验证码不正确";
	
	public final static int accMsgCodeEmailCodeTime = 4027;
	public final static String accMsgEmailCodeTime = "验证码已失效";
	
	public final static int accMsgCodeEmailCodeEmail = 4028;
	public final static String accMsgEmailCodeEmail = "邮箱已绑定";
}
