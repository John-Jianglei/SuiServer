...
public class NpcBattleVo extends BaseObject implements Serializable{
	...
	public boolean isHasRelive() {
		return hasRelive;
	}
	public void setHasRelive(boolean hasRelive) {
		this.hasRelive = hasRelive;
	}
	public boolean isHasWudi() {
		return hasWudi;
	}
	public void setHasWudi(boolean hasWudi) {
		this.hasWudi = hasWudi;
	}
