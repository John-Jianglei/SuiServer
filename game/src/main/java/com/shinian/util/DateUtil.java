...
public class DateUtil {
	...
	public static int MINUTE = 60 * SECOND;// 分钟
	...
	public static int getDifferDays(String begin_time, String end_time) {
		...
		int days = 0;
		days = (int) ((end_timea.getTime() - begin_times.getTime()) / (DAY ));
		return days;
	}
	...
	public static int getDifferTimes(String begin_time, String end_time) {
		...
		int days = 0;
//		System.err.println(end_timea.getTime() - begin_times.getTime());
		days = (int) ((end_timea.getTime() - begin_times.getTime()) / (MINUTE ));
		return days;
	}
	...
	/***
	 * 获取到当前时间N秒后的时间 返回格式为yyyy-MM-dd HH:mm:ss
	 * @param time
	 * @return
	 */
	...
	public static void main(String[] args) {
		System.out.println(getSubtractday("2011-09-12 12:23:20",-6,"yyyy-MM-dd"));
		
		int seconds = getDifferTimes_seconds2(new Date(), "20:00:00");
		
		String newtime = addTime_second2("20:00:00", 240);
	...
	public  static String getSat(){  
    	...
    	if(w == 1){
    		falllastime = DateUtil.getyesterday_day(5);
		}else if(w == 2){
			falllastime = DateUtil.getyesterday_day(4);
		}else if(w == 3){
			falllastime = DateUtil.getyesterday_day(3);
		}
		else if(w == 4){
			falllastime = DateUtil.getyesterday_day(2);
		}else if(w == 5){
			falllastime = DateUtil.getyesterday_day(1);
		}else if(w == 6){
			falllastime = DateUtil.getyesterday_day(0);
		}else if(w == 0){
			falllastime = DateUtil.getyesterday_day(6);
		}else{
			falllastime = DateUtil.getCurrentDay();
		}
    	return falllastime;
	} 
	public static String getStartSun()
	{
		String falllastime = "";
		Calendar cal = Calendar.getInstance();
    	cal.setTime(new Date());
	...
	public  static String getSun(){  
    	...
    	if(w == 1){
			...
			falllastime = DateUtil.getyesterday_day(8);
		}else if(w == 0){
			falllastime = DateUtil.getyesterday_day(7);
		}else{
			falllastime = DateUtil.getCurrentDay();
		}
    	return falllastime;
	...
	public  static String getRankedSunStart(){  
		String falllastime = "";
		Calendar cal = Calendar.getInstance();
    	cal.setTime(new Date());
    	...
    	if(w == 1){
			...
			falllastime = DateUtil.getyesterday_day(0);
			///判断在22点之后的情况
			if( DateUtil.isBegin( DateUtil.getCurrentDay()+" 22:00:00") )
			{
				falllastime = DateUtil.getyesterday_day(7);
			}
	...
	public static String getRankedSunEnd()
	{
		String falllastime = "";
		Calendar cal = Calendar.getInstance();
    	cal.setTime(new Date());
	...
	public static int getNewMonthLastDay()
	{
	...
	public static int getHHmmssTime()
    {
    	Date data = new Date();
